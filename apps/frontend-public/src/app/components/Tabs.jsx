  ...
  return (
    <div className="tabs flex flex-row gap-8 justify-end">
      {tabs.map((tab) => (
        <button
          key={tab.id}
          className={`tab bg-transparent border-none outline-none text-xs lg:text-base font-semibold relative pb-1 transition-colors duration-200 ${activeTab === tab.id ? 'text-black' : 'text-gray-500'} hover:text-black`}
