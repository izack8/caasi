    ...
    return (
        <section className="journey-section text-base text-justify w-full flex flex-col gap-y-5">
            <div className="flex flex-col md:flex-row sm:gap-x-5 items-center">
                ...
                Hello! My name is Isaac, or affectionately known as <b>izack/iz</b>. I'm a software engineer + ai/ml student, who loves to explore the intersection of technology and creativity, using technology to build fun and creative projects.
                </p>
