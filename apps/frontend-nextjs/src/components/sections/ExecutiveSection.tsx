...
function ExecutiveSection() {
    ...
    return (
        <section className="journey-section text-base text-justify w-full flex flex-col gap-y-5">
                <p>
                I'm a software engineer + ai/ml student, who loves to explore the intersection of creativity and engineering, using technology to build fun, creative projects.
                </p>
