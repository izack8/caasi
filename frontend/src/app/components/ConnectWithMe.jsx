...
function ConnectWithMe() {
    return (
        <div className="flex flex-col w-full mt-8 lg:mt-12">
            ...
            <div className="flex items-center gap-4 justify-center">
                <a 
                    ...
                    className="group flex items-center gap-2 text-slate-300 hover:text-zinc-900 transition-colors duration-200"
                >
                ...
                <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group flex items-center gap-2 text-slate-300 hover:text-blue-400 transition-colors duration-200"
                >
